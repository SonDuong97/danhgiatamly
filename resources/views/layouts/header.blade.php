        ...
        <nav class="navbar navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('home')}}">
                    <img src="{{asset('img/logo-black.png')}}" alt="TuvanHoc" class="main-logo" style="width: 50%;"/>
                    <img src="{{asset('img/logo-white.png')}}" alt="TuvanHoc" class="main-logo-light" style="width: 50%;border-radius: 5px;"/>
                </a>
                <!-- /Logo -->
            </div>
            <div class="collapse navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li id="question">
                        <a href="{{route('question')}}">Trắc nghiệm</a>
                    </li>
                    <li id="introduction">
