    ...
    <div class="container">
        <div class="col-md-offset-1 col-md-10">
            <div class="row heading">
                <h2><span>Kết quả đánh giá mức độ nhân cách của {{$user_name}}</span></h2>
            </div>
            <div class="row">
                    ...
                    @if(!empty($history))
                        <div class="row text-center">
                            ...
                            @foreach(json_decode($history->result, true) as $value)
                                ...
                                <div class="text-justify">{!! App\Helpers\Helper::getExQuestionNEOByTypeAndLevel($value['type'], $value['level'])->content !!}</div>
                            @endforeach
                        </div>
                    @endif
                </div>
