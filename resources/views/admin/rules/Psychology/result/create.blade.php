...
@section('title', 'Create Psychology Result Rule')
...
@section('content')
    ...
    @endif
    <form class="form" method="POST" action="{{route('psychologyresultrule.store')}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input name="average-value" class="form-control" placeholder="e.g 15.711" type="text" required>
                </div>
                <div class="form-group">
                    <label>Error value: </label>
                    <input name="error-value" class="form-control" placeholder="e.g 3.711" type="text" required>
                </div>
                <div class="row">
