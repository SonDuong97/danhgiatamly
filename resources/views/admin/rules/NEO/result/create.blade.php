...
@section('content')
    ...
    @endif
    <form class="form" method="POST" action="{{route('neoresultrule.store')}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>Score: </label>
                    <input name="score" class="form-control" placeholder="e.g 15.7" type="text" required>
                </div>
                <div class="row">
