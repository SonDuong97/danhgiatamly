    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" style="padding-bottom: 5px;">
                <a href="{{route('riasec.create')}}" class="col-xs-2 col-xs-offset-1 btn btn-success btn-lg pull-right"> Create
                    Question</a>
                <a href="{{route('riasec.export')}}" class="col-xs-2 btn btn-lg btn-danger pull-right"><i class="fa fa-download"> Export </i>  </a>
            </div>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @foreach ($questions as $key => $question)
                                    <tr>
                                        ...
                                        <td>
                                            {{\App\Helpers\Helper::getRiasecTypeById($question->type_id)->name}}
                                        </td>
                                        <td>
                                            {!! $question->content  !!}
                                        </td>
