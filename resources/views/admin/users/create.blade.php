        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input name="username" class="form-control" placeholder="e.g Customer" required>
                </div>
                <div class="form-group">
                    <label>Role:</label>
                ...
                <div class="form-group">
                    <label>Email:</label>
                    <input name="email" class="form-control" placeholder="e.g Customer@gmail.com" required>
                </div>
                <div class="form-group">
                ...
                <div class="row">
                    <div class="box-footer">
                        <div class="col-md-8 col-md-offset-4">
                            ...
                            <a type="button" class="btn btn-primary btn-lg" href="{{route('user.index')}}">Cancel</a>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
